...
# ffmpeg -i abc.mp4 -ss 00:00:18 -t 00:00:30 cde.mp4
...
while True:
	...
	# if the `q` key was pressed, break from the loop
		...
		break
	print("No. of frames processed "+str(cc), "Total time: " + str(time.time()-start))
	
print(time.time()-start)
# do a bit of cleanup
cv2.destroyAllWindows()
# vs.stop()
# No. of frames processed 750 Total time: 784.2828860282898